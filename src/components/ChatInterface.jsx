...
// 3D Emojis via Fluent Emoji CDN
const Emojis = {
  Send: "https://microsoft.github.io/fluentui-emoji/assets/Rocket/3D/rocket_3d.png",
  Music: "https://microsoft.github.io/fluentui-emoji/assets/Musical%20notes/3D/musical_notes_3d.png",
  Calendar: "https://microsoft.github.io/fluentui-emoji/assets/Calendar/3D/calendar_3d.png",
  Lightning: "https://microsoft.github.io/fluentui-emoji/assets/High%20voltage/3D/high_voltage_3d.png",
  WorldMap: "https://raw.githubusercontent.com/microsoft/fluentui-emoji/main/assets/World%20map/3D/world_map_3d.png",
  House: "https://raw.githubusercontent.com/microsoft/fluentui-emoji/main/assets/House/3D/house_3d.png"
};
      ...
      <div className="flex items-center gap-4">
        ...
        >
          {isPlaying ? (
            ...
            <img src={Emojis.Music} alt="Play" className="w-7 h-7 object-contain" />
          )}
        </button>
...
export const ChatInterface = () => {
        ...
        <div className="space-y-5 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          {imageUrl && (
            <div className="relative group">
              ...
              <div className="absolute top-4 right-4 bg-white/90 backdrop-blur px-3 py-1 rounded-full text-[10px] font-black text-gray-800 uppercase tracking-widest">Vibe Card</div>
            </div>
          )}
        ...
        <div className="space-y-5 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="flex justify-between items-start">
            ...
            {parsed.calendar_link && (
              <a href={gcalUrl} target="_blank" rel="noreferrer" className="flex items-center gap-2 bg-blue-600 text-white px-5 py-2.5 rounded-full text-xs font-black shadow-lg hover:bg-blue-700 transition-all hover:-translate-y-0.5 active:translate-y-0 uppercase tracking-widest shrink-0">
                <img src={Emojis.Calendar} alt="Calendar" className="w-4 h-4 object-contain brightness-200" /> 
                Block My Calendar
              </a>
            )}
          </div>
          ...
          <div className="bg-white/70 p-6 rounded-[2.5rem] border border-white shadow-sm space-y-6">
            <h4 className="font-black text-gray-800 uppercase tracking-widest text-xs flex items-center gap-2">
               <img src={Emojis.WorldMap} className="w-5 h-5" alt="Map" /> Curated Itinerary
            </h4>
  ...
  const getWelcomeMessage = () => {
    if (vibeMode === 'HOME_SANCTUARY') {
      return (
        <div className="bg-white/90 p-8 rounded-[3rem] border-4 border-white shadow-2xl text-gray-800 max-w-lg">
          ...
          <p className="text-2xl font-black mb-6 tracking-tight leading-tight">Heyy, I'm Lumi! Ready to teleport your home vibe?</p>
          <p className="text-[15px] text-gray-600 mb-8 leading-relaxed font-medium">Give me a mood (like <span className="text-pink-500 font-bold">'Harry Potter Library'</span> or <span className="text-blue-500 font-bold">'Cozy Ghibli'</span>), and I'll whip up a detailed recipe, music, and a niche hobby!</p>
          <div className="bg-white/50 p-5 rounded-3xl border border-white flex flex-col gap-3">
             <div className="flex items-center gap-3 text-xs font-bold text-gray-400 uppercase tracking-widest">
               <div className="w-2 h-2 bg-pink-400 rounded-full"></div> Checklist
             </div>
             <p className="text-sm font-bold text-gray-700">1. Select Mode: Home Sanctuary</p>
             <p className="text-sm font-bold text-gray-700">2. Set allergies in sidebar</p>
             <p className="text-sm font-bold text-gray-700">3. Drop a vibe below</p>
          </div>
        </div>
      );
    }
    return (
      <div className="bg-white/90 p-8 rounded-[3rem] border-4 border-white shadow-2xl text-gray-800 max-w-lg">
        ...
        <p className="text-2xl font-black mb-6 tracking-tight leading-tight">Heyy, I'm Lumi! Planning a Global Escape?</p>
        <p className="text-[15px] text-gray-600 mb-8 leading-relaxed font-medium">Tell me: <span className="font-bold text-blue-600">1. No. of days</span>, <span className="font-bold text-blue-600">2. Your vibe</span>, <span className="font-bold text-blue-600">3. Destination</span> (or ask me!), and <span className="font-bold text-blue-600">4. Your Budget</span>. I'll handle the itinerary, packing list, and outfits!</p>
        <div className="bg-white/50 p-5 rounded-3xl border border-white flex flex-col gap-3">
           <div className="flex items-center gap-3 text-xs font-bold text-gray-400 uppercase tracking-widest">
             <div className="w-2 h-2 bg-blue-400 rounded-full"></div> Action Items
           </div>
           <p className="text-sm font-bold text-gray-700">1. Switched to Trip Mode</p>
           <p className="text-sm font-bold text-gray-700">2. Set budget limit</p>
           <p className="text-sm font-bold text-gray-700">3. Describe your escape</p>
        </div>
      </div>
    );
  };
  ...
  return (
    <div className="flex-1 glass-card flex flex-col overflow-hidden relative shadow-2xl border-white/50">
      <div className="p-6 border-b border-white/40 flex justify-between items-center bg-white/40 backdrop-blur-xl">
        <h2 className="font-black text-gray-800 flex items-center gap-3 text-xl tracking-tighter uppercase">
          <img src={Emojis.Lightning} alt="Bolt" className="w-8 h-8 object-contain" /> Voyager Console
        </h2>
        <div className="flex items-center gap-2">
          <div className="flex h-2 w-2 rounded-full bg-green-500 animate-pulse"></div>
          <span className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Live Grounding Active</span>
        </div>
      </div>
        ...
        <form onSubmit={handleSend} className="flex gap-4">
          <div className="flex-1 relative group">
            ...
            <div className="absolute right-6 top-1/2 -translate-y-1/2 opacity-20 group-focus-within:opacity-100 transition-opacity">
               <img src={vibeMode === 'HOME_SANCTUARY' ? Emojis.House : Emojis.WorldMap} className="w-6 h-6 object-contain" />
            </div>
          </div>
          <button 
            type="submit"
          ...
          >
            <img src={Emojis.Send} alt="Send" className="w-8 h-8 object-contain brightness-200" />
          </button>
        </form>
      </div>
    </div>
